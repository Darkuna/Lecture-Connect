...
import com.lecture.coordinator.ui.beans.SessionInfoBean;
...
public class SessionInfoBeanTest {
    ...
    public void testLoggedIn() {
        ...
        Assertions.assertEquals("user1", sessionInfoBean.getCurrentUser().getUsername(),
                "sessionInfoBean.getCurrentUser does not return authenticated user");
        Assertions.assertEquals("EMPLOYEE", sessionInfoBean.getCurrentUserRoles(),
                "sessionInfoBean.getCurrentUserRoles does not return authenticated user's roles");
        Assertions.assertTrue(sessionInfoBean.hasRole("EMPLOYEE"),
